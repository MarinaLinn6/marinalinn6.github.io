...
gsap.to("#verticaltimeLeft", {
    scrollTrigger: {
        trigger: "#verticaltimeLeft", // start the animation when ".box" enters the viewport (once)
        toggleActions: "restart pause reverse pause",
        scrub: true
    },
    y: 100,
...
gsap.to("#horizontal", {
    scrollTrigger: {
        trigger: "#horizontal", // start the animation when ".box" enters the viewport (once)
        toggleActions: "restart pause reverse pause",
        scrub: 1
    },
    y: 100,
...
const cardhorizontal = document.getElementById("cardhorizontal");
 
cardhorizontal.addEventListener("click", () => {
    cardhorizontal.classList.toggle("active")
